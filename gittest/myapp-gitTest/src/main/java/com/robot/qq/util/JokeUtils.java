...
public class JokeUtils {
    ...
    private static String jokeList(String name, String num) {
        ...
        String joke3 = "那些别有用心的人是怎样黑##的？”\n" +
                "“他们把" + name + "说的内容原文复述了。”";

        String joke4 = "一个莫斯科市民的鹦鹉丢了。这是只会骂人的鹦鹉，要是落到" + name + "的手里可糟了。这人便在报纸 上发表了一篇声明：“本人遗失鹦鹉一只。另，本人不同意它的政治观点。”";

        String joke5 = "一天" + name + "因私外出，嫌司机车开的太慢，催促了好几次。但因交通拥挤，还是不能让他满意。最后##一把抢过方向盘，把司机推到后面，自己开起来。他一路横冲直撞，造成一片混乱。有人打电话向交通局长反映。 \n" +
                "\n" +
                "局长大怒，质问该地段交警。 \n" +
                "\n" +
                "局长：“看到肇事者没有？” \n" +
        ...
        String joke9 = name + "在揭露群主的暴行时，台下有人递条子上去。##当场宣读了条子的内容：“当时你在干什么？”。\n" +
                "\n" +
                "然后厉声喝道：“这是谁写的，请站出来！” \n" +
                "\n" +
        ...
        String joke11 = "战争时期，河内物资奇缺，向" + name + "求救。" + name + "电 ：勒紧腰带 。 河内回电 ：请给腰带 。";
